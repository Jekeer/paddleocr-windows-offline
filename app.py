...
def get_base_path():
    ...
    PyInstaller 6 的 onedir 模式下，
    数据资源通常位于：

        PaddleOCR-Offline/
        └── _internal/

    sys._MEIPASS 会指向实际的资源目录。
    """
...
class SettingsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.max_images_spin.setMinimum(
            1
        )

        self.max_images_spin.setMaximum(
            100
        )
        ...
        self.max_images_spin.setSuffix(
            " 张"
        )
